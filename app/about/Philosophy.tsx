    ...
    <section className="py-16 md:py-20 bg-gradient-to-br from-blue-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Medical Philosophy</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 text-center">Patient-Centered Care</h3>
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 text-center">Evidence-Based Practice</h3>
            <p className="text-gray-600 text-center leading-relaxed">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer sm:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 text-center">Continuous Learning</h3>
            <p className="text-gray-600 text-center leading-relaxed">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 text-center">Collaborative Approach</h3>
            <p className="text-gray-600 text-center leading-relaxed">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 text-center">Safety First</h3>
            <p className="text-gray-600 text-center leading-relaxed">
          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer sm:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4 text-center">Innovation</h3>
            <p className="text-gray-600 text-center leading-relaxed">
        ...
        <div className="mt-12 md:mt-16 text-center px-4">
          <blockquote className="text-xl md:text-2xl italic text-gray-700 max-w-4xl mx-auto leading-relaxed">
          ...
          <cite className="block mt-6 text-base md:text-lg font-semibold text-blue-900">— Dr. Narendra Pandit</cite>
        </div>
      </div>
    </section>
  );
