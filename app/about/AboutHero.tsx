...
export default function AboutHero() {
  return (
    <section className="relative py-16 sm:py-20 overflow-hidden">
      ...
      {/* Floating elements */}
      <div className="hidden sm:block absolute bottom-20 right-10 w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center text-white/20 animate-bounce delay-1">
        <i className="ri-user-heart-line text-3xl"></i>
      </div>
      <div className="absolute bottom-20 right-10 w-16 h-16 flex items-center justify-center text-white/20 animate-bounce delay-1">
