        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <div className="relative">
            <img
              ...
              className="w-full max-w-xs sm:max-w-md mx-auto lg:mx-0 rounded-2xl shadow-2xl object-cover object-top transform hover:scale-105 transition-transform duration-500"
            />
          ...
          <div className="text-center lg:text-left">
            <h2 className="heading-secondary text-gray-900 mb-6">Personal Background</h2>
