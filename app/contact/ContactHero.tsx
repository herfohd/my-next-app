      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white">
          ...
          <div className="flex justify-center space-x-8 mt-12">
            ...
            >
              <div className="w-16 h-16 flex items-center justify-center bg-white/20 rounded-full mx-auto mb-3 group-hover:bg-white/30 group-hover:shadow-lg transition-all">
