  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {memberships.map((membership, index) => (
                <div key={index} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="text-lg font-bold text-gray-900">{membership.organization}</h3>
                    <span className="text-sm text-blue-600 bg-blue-100 px-3 py-1 rounded-full">Since {membership.since}</span>
                  </div>
                  <p className="text-blue-600 font-semibold mb-2">{membership.role}</p>
                  <p className="text-gray-700 text-sm leading-relaxed">{membership.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-6 max-h-96 overflow-y-auto">
              {awards.map((award, index) => (
                <div key={index} className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl shadow-lg p-6 border-l-4 border-yellow-500 hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-600 font-semibold">{award.organization} • {award.year}</p>
                    </div>
                  </div>
        ...
        <div className="mt-16">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Academic Leadership</h2>
            <p className="text-xl text-gray-600">
            ...
            {academicRoles.map((role, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer">
                <div className="text-center mb-4">
                  ...
                  <p className="text-blue-600 font-semibold mb-2">{role.organization}</p>
                  <p className="text-gray-500 text-sm mb-3">{role.period || role.year}</p>
                </div>
                <p className="text-gray-700 text-sm leading-relaxed text-center">{role.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Research & Publications</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="group cursor-pointer">
              <div className="text-3xl font-bold text-blue-900 mb-2 group-hover:text-blue-700 transition-colors">71+</div>
              <div className="text-gray-600 text-sm">Published Papers</div>
            </div>
            <div className="group cursor-pointer">
              <div className="text-3xl font-bold text-blue-900 mb-2 group-hover:text-blue-700 transition-colors">4</div>
              <div className="text-gray-600 text-sm">Principal Investigator Research</div>
            </div>
            <div className="group cursor-pointer">
              <div className="text-3xl font-bold text-blue-900 mb-2 group-hover:text-blue-700 transition-colors">15+</div>
              <div className="text-gray-600 text-sm">Years Experience</div>
            </div>
            <div className="group cursor-pointer">
              <div className="text-3xl font-bold text-blue-900 mb-2 group-hover:text-blue-700 transition-colors">MCh</div>
              <div className="text-gray-600 text-sm">Surgical Gastroenterology</div>
            </div>
          </div>
        </div>
      </div>
